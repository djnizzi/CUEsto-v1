        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm px-4">
            ...
            >
                ...
                <p className="text-brand-text text-modal-body font-light leading-relaxed">
                    ...
                    , and copy the release code from a release page (master releases won't work). it is possible to interpolate start times and durations from a release, if it has track durations, with the selected audio file's total duration. the resulting durations are estimates and not exact, as Discogs timings don't have the precision of those in a .cue file
                </p>
